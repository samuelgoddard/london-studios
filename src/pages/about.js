      ...
      >
        ...
        >
          <div className="container">
            <div className="flex flex-wrap items-end mb-8 md:mb-12" data-sal="fade" data-sal-delay="0" data-sal-easing="ease">
            ...
            <div className="flex flex-wrap md:-mx-6" data-sal="fade" data-sal-delay="0" data-sal-easing="ease">
              ...
              <div className="w-full md:w-3/12 md:px-6" data-sal="fade" data-sal-delay="0" data-sal-easing="ease">
